...
class ImagePrompt(BaseModel):
    ...
    def initialize_default_prompts(cls):
        ...
        default_prompts = [
            ...
            " A (22.3) year old (woman:1.1) with (dark:1.2) wavy long hair is totally (naked:1.1) on a sandy beach She is only wearing a red BDSM (choker:1.1) and She is (sensual:1.4) and (glistening:1.2). The scene is shot with (Kodakportra1600:1.1) (filmgrain:1.1) (Analogcamera:1.1) (Sharpdetails:1.1) (50mm:1.1)",
        ]
